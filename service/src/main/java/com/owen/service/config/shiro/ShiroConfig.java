package com.owen.service.config.shiro;
...
import com.owen.service.IResourceService;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.owen.Resource> list = resourceService.findAll();
		for (com.owen.Resource resource : list) {
